  ...
  return (
    <MobileFrame withNav>
      <header className="px-5 pt-5 pb-2 flex items-center gap-2">
        ...
        <h1 className="text-[18px] font-bold">{t("action.title")}</h1>
      </header>

      <div className="px-5 pb-6 flex-1 flex flex-col gap-4">
        <p className="text-[14px] text-muted-foreground">{t("action.subtitle")}</p>
        ...
        <div className="rounded-2xl bg-card p-4 shadow-card border border-border/60">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <h3 className="font-semibold text-[15px]">{t("action.card1_title")}</h3>
              <p className="text-[13px] text-muted-foreground mt-1 leading-relaxed">
                {t("action.card1_desc")}
              </p>
              <Link
                to="/lavoura"
                className="inline-flex items-center gap-1 mt-3 text-[13px] font-semibold text-navy"
              >
        ...
        <div className="rounded-2xl bg-card p-4 shadow-card border-l-4 border-navy">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <h3 className="font-semibold text-[15px]">{t("action.card2_title")}</h3>
              <p className="text-[13px] text-muted-foreground mt-1 leading-relaxed">
                {t("action.card2_desc")}
              </p>
              <Link
                to="/programas"
                className="inline-flex items-center gap-1.5 mt-3 h-9 px-3 rounded-lg bg-navy text-navy-foreground text-[13px] font-semibold"
              >
        ...
        <article className="rounded-2xl bg-card p-4 shadow-card border border-border/60">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 flex-wrap">
                <h3 className="font-bold text-[15px]">{t("protection.title")}</h3>
          ...
          <div className="mt-3 rounded-xl bg-soft px-3 py-2.5 text-[12.5px] text-foreground/80 font-medium">
