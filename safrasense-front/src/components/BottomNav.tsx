...
import { Sprout, Landmark, ShieldCheck, User, MessageSquare } from "lucide-react";
...
export function BottomNav() {
  ...
  const tabs = [
    ...
    { to: "/protecao", label: t("nav.protection"), Icon: ShieldCheck },
  ...
  return (
    <>
      <nav
        className="sticky bottom-0 left-0 right-0 bg-white border-t border-border shadow-[0_-2px_12px_rgba(0,0,0,0.04)] z-30"
            ...
            return (
              <li key={to}>
                <Link
                  ...
                  style={{ color: active ? "var(--primary)" : "#8C7B6E" }}
                >
