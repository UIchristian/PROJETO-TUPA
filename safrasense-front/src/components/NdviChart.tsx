    ...
    <div className="w-full flex flex-col">
      ...
      <div className="mt-4 rounded-xl border border-border/40 overflow-hidden bg-card">
        <div className="grid grid-cols-[1.4fr_0.8fr_0.8fr] gap-2 px-3 py-2 bg-secondary/60 text-sm font-bold text-foreground/80">
          ...
          <span className="text-center">
            {language === "es" ? "Prom. histórico" : language === "en" ? "Hist. avg" : "Média Histórica"}
          </span>
        </div>
        ...
        >
          ...
          <div className="px-5 py-4 border-b border-border flex items-center justify-between shrink-0">
            <h2 className="text-base font-bold text-foreground">
              {language === "es" ? "¿Qué es el NDVI?" : language === "en" ? "What is NDVI?" : "O que é NDVI?"}
            </h2>
            <button
              type="button"
              onClick={() => setShowNdviInfo(false)}
          ...
          <div className="flex-1 overflow-y-auto px-5 py-5 flex flex-col gap-4 text-sm text-foreground/90 leading-relaxed">
            ...
            <section className="flex flex-col gap-1.5">
              <h3 className="font-bold text-foreground">
                {language === "es" ? "Escala de valores" : language === "en" ? "Value scale" : "Escala de valores"}
              </h3>
              <p>
                {language === "es"
            ...
            <section className="flex flex-col gap-2">
              <h3 className="font-bold text-foreground">
                {language === "es" ? "Interpretación en SafraSense" : language === "en" ? "Interpretation in SafraSense" : "Interpretação no SafraSense"}
              </h3>
