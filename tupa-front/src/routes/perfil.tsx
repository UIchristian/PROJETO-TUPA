...
import { ArrowLeft, UserCircle, Camera, Lock, Mail, Building, Key, Headset, Laptop, TreePine, Sailboat, Tent, Wheat, X } from "lucide-react";
      ...
      <div className="max-w-3xl w-full mx-auto space-y-6">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-3xl font-extrabold tracking-tight text-foreground">Perfil Profissional</h2>
              <p className="text-muted-foreground mt-1">Gerencie suas informações e credenciais de acesso do backoffice.</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-card rounded-2xl border border-border shadow-soft overflow-hidden p-6 mt-4 relative">
          ...
          <div className="py-6 border-y border-border flex items-center justify-between">
            <div className="space-y-1">
              ...
              <p className="text-sm text-muted-foreground">Atualize sua senha de acesso ao sistema Tupã.</p>
            </div>
            <button 
            ...
            <div className="grid grid-cols-3 gap-4">
              {PRESET_AVATARS.map((avatar) => {
                ...
                return (
                  ...
                  >
                    <div className={`w-14 h-14 rounded-full flex items-center justify-center ${avatar.bg}`}>
