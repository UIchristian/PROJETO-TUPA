...
function PathCard({
  ...
  return (
    <div
      onClick={onClick}
      className={`rounded-2xl bg-card p-4 shadow-card border-2 transition-all cursor-pointer active:scale-[0.995] ${
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center justify-between gap-2">
            ...
            {badge && (
              <span className="text-xs font-bold tracking-wide bg-primary text-primary-foreground px-2.5 py-0.5 rounded-full whitespace-nowrap">
                {badge}
              </span>
            )}
          </div>
